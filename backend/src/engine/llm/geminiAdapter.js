...
${haltedBlock}
{
  "plain_summary": "개발/기술 용어를 전혀 쓰지 않고, 이번 QA에서 무엇을 확인했고 결과가 어땠는지를 비개발자도 바로 이해할 수 있게 1~2문장으로 설명해라. '콘솔 에러', 'execWarning', '네트워크 요청', '셀렉터' 같은 단어는 절대 쓰지 말고, 사용자가 실제로 그 기능을 못 쓰게 되는지 아닌지를 중심으로 써라.",
